      ...
      <div class="bg-white rounded-sm border dark:border-gray-700 dark:bg-gray-800 my-4 shadow-md">
        <div class="p-2">
          <p class="text-sm my-4">
            <b class="text-base">Главный Сварщик</b> - предлогает Вам большой выбор расходных материалов для любых целей: омеднённая, порошковая проволока, электроды. Также, в нашем интернет-магазине вы можете приобрести сопутствующие товары: кабельные разъёмы, электроды, держатели или клеммы заземления, необходимые приспособления при проведении электросварочных работ и многое другое.
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-white rounded-sm border dark:border-gray-700 dark:bg-gray-800 shadow-md">
          <div class="p-2 text-center">
            <p class="text-base my-2">ГАРАНТИРУЕМ:</p>
            <p class="text-sm">
        ...
        <div class="bg-white rounded-sm border dark:border-gray-700 dark:bg-gray-800 shadow-md">
          <div class="p-2 text-center">
            <p class="text-base my-2">ПОМОЖЕМ:</p>
            <p class="text-sm">
        ...
        <div class="bg-white rounded-sm border dark:border-gray-700 dark:bg-gray-800 shadow-md">
          <div class="p-2 text-center">
            <p class="text-base my-2">ПОДСКАЖЕМ:</p>
            <p class="text-sm">
